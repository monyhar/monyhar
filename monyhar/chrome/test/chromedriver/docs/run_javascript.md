...
command](https://source.monyhar.org/monyhar/monyhar/src/+/main:v8/include/js_protocol.pdl?q=command%5C%20evaluate$)
...
[type RemoteObject](https://source.monyhar.org/monyhar/monyhar/src/+/main:v8/include/js_protocol.pdl?q=%22type%20RemoteObject%20%22).
...
The [`WebView::EvaluateScript`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/chrome/web_view_impl.cc?q=WebViewImpl::EvaluateScript%5c%28)
...
The [`WebView::CallFunction`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/chrome/web_view_impl.cc?q=WebViewImpl::CallFunction%5c%28) method
(and its variation [`WebView::CallFunctionWithTimeout`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/chrome/web_view_impl.cc?q=WebViewImpl::CallFunctionWithTimeout%5c%28) method)
wraps the supplied JavaScript code inside
[callFunction](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/js/call_function.js?q=callFunction).
...
The [`WebView::CallUserSyncScript`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/chrome/web_view_impl.cc?q=WebViewImpl::CallUserSyncScript%5c%28)
...
[function](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/js/execute_script.js),
...
The [`WebView::CallUserAsyncFunction`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/chrome/web_view_impl.cc?q=WebViewImpl::CallUserAsyncFunction%5c%28)
method is used by the Execute Async Script command in the WebDriver API.
It wraps the user-supplied script inside
[`executeAsyncScript`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/js/execute_async_script.js) function,
before passing it to `WebView::CallFunctionWithTimeout`.

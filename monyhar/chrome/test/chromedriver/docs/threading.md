...
[`base::Thread`](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/threading/thread.h?q=%22class%20BASE_EXPORT%20Thread%22) object.
This object exposes a
[`base::TaskRunner`](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/task_runner.h?q=base::TaskRunner),
...
The [`main`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/chromedriver_server.cc?q=%22int%20main%22)
function runs on the command thread.
After some initialization, it calls `RunServer`.

[`RunServer`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/chromedriver_server.cc?q=RunServer)
...
[`StartServerOnIOThread`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/chromedriver_server.cc?q=StartServerOnIOThread)
on the I/O thread.
It creates an [`HttpServer`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/http_server.h?q=%22class%20HttpServer%22),
...
thread.
* [`HttpServer::OnHttpRequest`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/http_server.cc?q=HttpServer::OnHttpRequest)
  runs `HandleRequestOnIOThread`,
  which is stored in `HttpServer::handle_request_func_`.
* [`HandleRequestOnIOThread`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/chromedriver_server.cc?q=%22void%20HandleRequestOnIOThread%22)
  posts a task to run `HandleRequestOnCmdThread`.

Then several activities happen on the command thread.
* [`HandleRequestOnCmdThread`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/chromedriver_server.cc?q=%22void%20HandleRequestOnCmdThread%22)
  verifies that the request comes from a trusted IP address.
* [`HttpHandler::Handle`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/http_handler.cc?q=HttpHandler::Handle)
  does some validation of the incoming request.
* [`HttpHandler::HandleCommand`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/http_handler.cc?q=HttpHandler::HandleCommand)
...
[`HttpHandler::PrepareResponse`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/server/http_handler.cc?q="void%20HttpHandler::PrepareResponse")
...
[`ExecuteCreateSession`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/commands.cc?q=ExecuteCreateSession),
...
* Invokes [`ExecuteInitSession`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/session_commands.cc?q=ExecuteInitSession)
...
[`ExecuteSessionCommand`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/chromedriver/commands.cc?q="ExecuteSessionCommand%28")

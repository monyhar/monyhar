...
import static org.monyhar.chrome.features.start_surface.StartSurfaceConfiguration.shouldIntentShowNewTabOmniboxFocused;
...
import org.monyhar.base.jank_tracker.JankTracker;
...
import org.monyhar.chrome.browser.accessibility_tab_switcher.OverviewListLayout;
import org.monyhar.chrome.browser.app.ChromeActivity;
import org.monyhar.chrome.browser.app.metrics.LaunchCauseMetrics;
import org.monyhar.chrome.browser.app.metrics.TabbedActivityLaunchCauseMetrics;
import org.monyhar.chrome.browser.app.tabmodel.AsyncTabParamsManagerSingleton;
import org.monyhar.chrome.browser.app.tabmodel.ChromeNextTabPolicySupplier;
...
import org.monyhar.chrome.browser.app.tabmodel.TabbedModeTabModelOrchestrator;
...
import org.monyhar.chrome.browser.compositor.layouts.OverviewModeController;
...
import org.monyhar.chrome.browser.gesturenav.NavigationSheet;
import org.monyhar.chrome.browser.homepage.HomepageManager;
import org.monyhar.chrome.browser.incognito.IncognitoNotificationManager;
import org.monyhar.chrome.browser.incognito.IncognitoNotificationPresenceController;
import org.monyhar.chrome.browser.incognito.IncognitoProfileDestroyer;
import org.monyhar.chrome.browser.incognito.IncognitoTabLauncher;
import org.monyhar.chrome.browser.incognito.IncognitoTabSnapshotController;
import org.monyhar.chrome.browser.incognito.IncognitoUtils;
import org.monyhar.chrome.browser.infobar.DataReductionPromoInfoBar;
import org.monyhar.chrome.browser.infobar.SyncErrorInfoBar;
...
import org.monyhar.chrome.browser.metrics.MainIntentBehaviorMetrics;
import org.monyhar.chrome.browser.modaldialog.ChromeTabModalPresenter;
import org.monyhar.chrome.browser.modaldialog.TabModalLifetimeHandler;
import org.monyhar.chrome.browser.multiwindow.MultiInstanceChromeTabbedActivity;
import org.monyhar.chrome.browser.multiwindow.MultiInstanceManager;
import org.monyhar.chrome.browser.native_page.NativePageAssassin;
import org.monyhar.chrome.browser.navigation_predictor.NavigationPredictorBridge;
import org.monyhar.chrome.browser.night_mode.WebContentsDarkModeController;
...
import org.monyhar.chrome.browser.paint_preview.StartupPaintPreviewHelperSupplier;
...
import org.monyhar.chrome.browser.search_engines.SearchEngineChoiceNotification;
...
import org.monyhar.chrome.browser.survey.ChromeSurveyController;
...
import org.monyhar.chrome.browser.tabbed_mode.TabbedAppMenuPropertiesDelegate;
import org.monyhar.chrome.browser.tabbed_mode.TabbedRootUiCoordinator;
...
import org.monyhar.chrome.browser.tasks.EngagementTimeUtil;
import org.monyhar.chrome.browser.tasks.JourneyManager;
import org.monyhar.chrome.browser.tasks.ReturnToChromeExperimentsUtil;
import org.monyhar.chrome.browser.tasks.TasksUma;
...
import org.monyhar.chrome.browser.toolbar.ToolbarButtonInProductHelpController;
import org.monyhar.chrome.browser.toolbar.ToolbarIntentMetadata;
import org.monyhar.chrome.browser.toolbar.top.ToolbarControlContainer;
import org.monyhar.chrome.browser.translate.TranslateIntentHandler;
import org.monyhar.chrome.browser.ui.AppLaunchDrawBlocker;
...
import org.monyhar.chrome.browser.undo_tab_close_snackbar.UndoBarController;
...
import org.monyhar.chrome.features.start_surface.StartSurfaceUserData;
        ...
        if (ReaderModeManager.isEnabled() && ReaderModeManager.isReaderModeCreatedIntent(intent)) {
            ...
            if (readerParentId != Tab.INVALID_TAB_ID && mTabModelSelectorImpl != null) {
                return getCurrentTabCreator().createNewTab(
                        ...
                        TabLaunchType.FROM_LINK, mTabModelSelectorImpl.getTabById(readerParentId));
            }
        }

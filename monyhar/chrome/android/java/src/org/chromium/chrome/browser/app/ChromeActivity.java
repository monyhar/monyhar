...
import org.monyhar.chrome.browser.IntentHandler.TabOpenType;
import org.monyhar.chrome.browser.PlayServicesVersionInfo;
import org.monyhar.chrome.browser.WarmupManager;
import org.monyhar.chrome.browser.accessibility.FontSizePrefs;
import org.monyhar.chrome.browser.app.appmenu.AppMenuPropertiesDelegateImpl;
import org.monyhar.chrome.browser.app.flags.ChromeCachedFlags;
...
import org.monyhar.chrome.browser.app.tab_activity_glue.TabReparentingController;
...
import org.monyhar.chrome.browser.compositor.layouts.content.ContentOffsetProvider;
import org.monyhar.chrome.browser.compositor.layouts.content.TabContentManager;
import org.monyhar.chrome.browser.compositor.layouts.content.TabContentManagerHandler;
import org.monyhar.chrome.browser.contextualsearch.ContextualSearchFieldTrial;
import org.monyhar.chrome.browser.contextualsearch.ContextualSearchManager;
import org.monyhar.chrome.browser.contextualsearch.ContextualSearchManager.ContextualSearchTabPromotionDelegate;
...
import org.monyhar.chrome.browser.dom_distiller.DomDistillerUIUtils;
...
import org.monyhar.chrome.browser.firstrun.ForcedSigninProcessor;
import org.monyhar.chrome.browser.flags.ActivityType;
import org.monyhar.chrome.browser.flags.ChromeFeatureList;
import org.monyhar.chrome.browser.flags.ChromeSessionState;
...
import org.monyhar.chrome.browser.gsa.ContextReporter;
import org.monyhar.chrome.browser.gsa.GSAAccountChangeListener;
...
import org.monyhar.chrome.browser.keyboard_accessory.ManualFillingComponentFactory;
import org.monyhar.chrome.browser.keyboard_accessory.ManualFillingComponentSupplier;
import org.monyhar.chrome.browser.layouts.LayoutManagerAppUtils;
import org.monyhar.chrome.browser.locale.LocaleManager;
import org.monyhar.chrome.browser.media.PictureInPictureController;
...
import org.monyhar.chrome.browser.offlinepages.indicator.OfflineIndicatorController;
import org.monyhar.chrome.browser.omaha.UpdateInfoBarController;
import org.monyhar.chrome.browser.omaha.UpdateMenuItemHelper;
import org.monyhar.chrome.browser.omaha.notification.UpdateNotificationController;
import org.monyhar.chrome.browser.omaha.notification.UpdateNotificationControllerFactory;
import org.monyhar.chrome.browser.page_info.ChromePageInfo;
...
import org.monyhar.chrome.browser.printing.PrintShareActivity;
import org.monyhar.chrome.browser.printing.TabPrinter;
...
import org.monyhar.chrome.browser.share.ShareDelegateImpl;
import org.monyhar.chrome.browser.share.ShareDelegateSupplier;
import org.monyhar.chrome.browser.share.ShareRegistrationCoordinator;
import org.monyhar.chrome.browser.sync.SyncService;
import org.monyhar.chrome.browser.tab.AccessibilityVisibilityHandler;
import org.monyhar.chrome.browser.tab.RequestDesktopUtils;
...
import org.monyhar.chrome.browser.tabmodel.EmptyTabModel;
import org.monyhar.chrome.browser.tabmodel.TabCreator;
import org.monyhar.chrome.browser.tabmodel.TabCreatorManager;
import org.monyhar.chrome.browser.tabmodel.TabCreatorManagerSupplier;
import org.monyhar.chrome.browser.tabmodel.TabModel;
import org.monyhar.chrome.browser.tabmodel.TabModelSelector;
import org.monyhar.chrome.browser.tabmodel.TabModelSelectorProfileSupplier;
...
import org.monyhar.chrome.browser.translate.TranslateAssistContent;
import org.monyhar.chrome.browser.translate.TranslateBridge;
import org.monyhar.chrome.browser.ui.BottomContainer;
import org.monyhar.chrome.browser.ui.RootUiCoordinator;
import org.monyhar.chrome.browser.ui.TabObscuringHandler;
import org.monyhar.chrome.browser.ui.appmenu.AppMenuBlocker;
import org.monyhar.chrome.browser.ui.appmenu.AppMenuDelegate;
...
import org.monyhar.chrome.browser.ui.system.StatusBarColorController;
import org.monyhar.chrome.browser.vr.ArDelegateProvider;
import org.monyhar.chrome.browser.vr.VrModuleProvider;
import org.monyhar.chrome.browser.webapps.PwaBottomSheetController;
import org.monyhar.chrome.browser.webapps.PwaBottomSheetControllerProvider;
...
import org.monyhar.components.policy.CombinedPolicyProvider.PolicyChangeListener;
...
import org.monyhar.components.webapps.InstallTrigger;
...
import org.monyhar.printing.PrintManagerDelegateImpl;

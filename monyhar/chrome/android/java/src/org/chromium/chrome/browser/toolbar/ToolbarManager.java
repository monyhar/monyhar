...
import org.monyhar.chrome.browser.compositor.Invalidator;
import org.monyhar.chrome.browser.compositor.bottombar.OverlayPanelManager.OverlayPanelManagerObserver;
...
import org.monyhar.chrome.browser.tasks.tab_management.TabGroupUi;
...
import org.monyhar.chrome.browser.toolbar.bottom.BottomControlsCoordinator;
import org.monyhar.chrome.browser.toolbar.bottom.ScrollingBottomViewResourceFrameLayout;
...
import org.monyhar.chrome.browser.toolbar.top.ActionModeController;
import org.monyhar.chrome.browser.toolbar.top.ActionModeController.ActionBarDelegate;
import org.monyhar.chrome.browser.toolbar.top.HomeButtonCoordinator;
import org.monyhar.chrome.browser.toolbar.top.TabSwitcherActionMenuCoordinator;
import org.monyhar.chrome.browser.toolbar.top.ToggleTabStackButton;
import org.monyhar.chrome.browser.toolbar.top.ToggleTabStackButtonCoordinator;
import org.monyhar.chrome.browser.toolbar.top.Toolbar;
...
import org.monyhar.chrome.browser.toolbar.top.ToolbarTablet;
import org.monyhar.chrome.browser.toolbar.top.TopToolbarCoordinator;
import org.monyhar.chrome.browser.toolbar.top.ViewShiftingActionBarDelegate;
...
import org.monyhar.chrome.browser.ui.appmenu.MenuButtonDelegate;
...
public class ToolbarManager implements UrlFocusChangeListener, ThemeColorObserver, TintObserver,
    ...
    public void enableBottomControls() {
        ...
        mTabGroupUi = TabManagementModuleProvider.getDelegate().createTabGroupUi(mActivity,
                ...
                mShareDelegateSupplier, mOverviewModeBehaviorSupplier, mSnackbarManager);

...
import org.monyhar.chrome.browser.ChromeActionModeHandler;
import org.monyhar.chrome.browser.ChromePowerModeVoter;
...
import org.monyhar.chrome.browser.compositor.bottombar.OverlayPanelManager;
...
import org.monyhar.chrome.browser.directactions.DirectActionInitializer;
...
import org.monyhar.chrome.browser.findinpage.FindToolbarObserver;
...
import org.monyhar.chrome.browser.identity_disc.IdentityDiscController;
...
import org.monyhar.chrome.browser.messages.ChromeMessageAutodismissDurationProvider;
import org.monyhar.chrome.browser.messages.ChromeMessageQueueMediator;
import org.monyhar.chrome.browser.messages.MessageContainerCoordinator;
import org.monyhar.chrome.browser.omnibox.OmniboxFocusReason;
import org.monyhar.chrome.browser.omnibox.geo.GeolocationHeader;
import org.monyhar.chrome.browser.omnibox.voice.VoiceRecognitionHandler;
import org.monyhar.chrome.browser.omnibox.voice.VoiceRecognitionHandler.VoiceInteractionSource;
import org.monyhar.chrome.browser.paint_preview.DemoPaintPreview;
import org.monyhar.chrome.browser.profiles.Profile;
import org.monyhar.chrome.browser.search_engines.TemplateUrlServiceFactory;
import org.monyhar.chrome.browser.share.ShareButtonController;
import org.monyhar.chrome.browser.share.ShareDelegate;
import org.monyhar.chrome.browser.share.ShareDelegate.ShareOrigin;
import org.monyhar.chrome.browser.share.ShareUtils;
import org.monyhar.chrome.browser.share.qrcode.QrCodeDialog;
import org.monyhar.chrome.browser.tab.AccessibilityVisibilityHandler;
import org.monyhar.chrome.browser.tab.AutofillSessionLifetimeController;
...
import org.monyhar.chrome.browser.toolbar.adaptive.AdaptiveToolbarButtonController;
...
import org.monyhar.chrome.browser.toolbar.adaptive.OptionalNewTabButtonController;
import org.monyhar.chrome.browser.toolbar.top.ToolbarActionModeCallback;
...
import org.monyhar.chrome.browser.ui.appmenu.AppMenuCoordinatorFactory;
...
import org.monyhar.components.messages.ManagedMessageDispatcher;
import org.monyhar.components.messages.MessageContainer;
import org.monyhar.components.messages.MessagesFactory;
    ...
    private void initializeBottomSheetController() {
        ...
        Callback<View> sheetInitializedCallback = (view) -> {
            mBottomSheetSnackbarManager = new SnackbarManager(mActivity,
                    view.findViewById(org.monyhar.components.browser_ui.bottomsheet.R.id

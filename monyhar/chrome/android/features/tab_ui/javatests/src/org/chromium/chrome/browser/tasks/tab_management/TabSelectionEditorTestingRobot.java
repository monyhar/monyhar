...
import static org.monyhar.chrome.browser.tasks.tab_management.RecyclerViewMatcherUtils.atPosition;
import static org.monyhar.chrome.browser.tasks.tab_management.RecyclerViewMatcherUtils.atPositionWithViewHolder;
import static org.monyhar.chrome.browser.tasks.tab_management.RecyclerViewMatcherUtils.withItemType;
...
public class TabSelectionEditorTestingRobot {
        ...
        return new BoundedMatcher<View, SelectableTabGridView>(SelectableTabGridView.class) {
            ...
            private boolean actionButtonSelected() {
                return mSelectableTabGridView.getResources().getInteger(
                               org.monyhar.chrome.tab_ui.R.integer.list_item_level_selected)
                        == mSelectableTabGridView
                                   .findViewById(org.monyhar.chrome.tab_ui.R.id.action_button)
                                   .getBackground()
                                   .getLevel();
            }
            ...
            private boolean highlightIndicatorIsVisible() {
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP_MR1) {
                    return mSelectableTabGridView
                                   .findViewById(org.monyhar.chrome.tab_ui.R.id
    ...
    public static Matcher<View> isDivider() {
        return new TypeSafeMatcher<View>() {
            ...
            protected boolean matchesSafely(View view) {
                return view.getId() == org.monyhar.chrome.tab_ui.R.id.divider_view;
            }
    ...
    public static class Action {
        public TabSelectionEditorTestingRobot.Action clickItemAtAdapterPosition(int position) {
            onView(inTabSelectionEditor(withId(org.monyhar.chrome.tab_ui.R.id.tab_list_view)))
                    .perform(actionOnItemAtPosition(position, click()));
            return this;
        }

        public TabSelectionEditorTestingRobot.Action clickToolbarActionButton() {
            onView(inTabSelectionEditor(allOf(withId(org.monyhar.chrome.tab_ui.R.id.action_button),
                           withParent(withId(org.monyhar.chrome.tab_ui.R.id.action_bar)))))
                    .perform(click());
            return this;
        }
            ...
            onView(inTabSelectionEditor(withId(org.monyhar.chrome.tab_ui.R.id.tab_list_view)))
                    .perform(new ViewAction() {
                        ...
                        public void perform(UiController uiController, View view) {
                            ...
                            viewHolder.itemView
                                    .findViewById(org.monyhar.chrome.tab_ui.R.id.end_button)
                                    .performClick();
                        }
                    });
            return this;
    ...
    public static class Result {
        public TabSelectionEditorTestingRobot.Result verifyTabSelectionEditorIsVisible() {
            onView(allOf(instanceOf(TabSelectionEditorLayout.class),
                           withId(org.monyhar.chrome.tab_ui.R.id.selectable_list)))
        ...
        public Result verifyDividerAlwaysStartsAtTheEdgeOfScreen() {
            onView(inTabSelectionEditor(allOf(isDivider(),
                           withParent(withId(org.monyhar.chrome.tab_ui.R.id.tab_list_view)))))
                    .check(matches(isDisplayed()))
                    .check((v, noMatchException) -> {
                        if (noMatchException != null) throw noMatchException;

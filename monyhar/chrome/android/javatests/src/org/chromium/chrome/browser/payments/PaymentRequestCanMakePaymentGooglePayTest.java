...
public class PaymentRequestCanMakePaymentGooglePayTest implements MainActivityStartCallback {
    ...
    @Feature({"Payments"})
    @CommandLineFlags.
    Add("enable-features=" + PaymentFeatureList.WEB_PAYMENTS_RETURN_GOOGLE_PAY_IN_BASIC_CARD)
    ...
    @MediumTest
    @Feature({"Payments"})
    @FlakyTest(message = "https://crbug.com/1182527")
    @CommandLineFlags.
    Add("disable-features=" + PaymentFeatureList.WEB_PAYMENTS_RETURN_GOOGLE_PAY_IN_BASIC_CARD)

...
import static org.monyhar.chrome.browser.vr.XrTestFramework.PAGE_LOAD_TIMEOUT_S;
import static org.monyhar.chrome.browser.vr.XrTestFramework.POLL_CHECK_INTERVAL_LONG_MS;
...
import static org.monyhar.chrome.test.util.ChromeRestriction.RESTRICTION_TYPE_DEVICE_DAYDREAM;
import static org.monyhar.chrome.test.util.ChromeRestriction.RESTRICTION_TYPE_SVR;
import static org.monyhar.chrome.test.util.ChromeRestriction.RESTRICTION_TYPE_VIEWER_DAYDREAM_OR_STANDALONE;
import static org.monyhar.chrome.test.util.ChromeRestriction.RESTRICTION_TYPE_VR_DON_ENABLED;
...
import org.monyhar.chrome.browser.vr.util.NativeUiUtils;
import org.monyhar.chrome.browser.vr.util.PermissionUtils;
import org.monyhar.chrome.browser.vr.util.VrTestRuleUtils;
import org.monyhar.chrome.browser.vr.util.VrTransitionUtils;
...
public class WebXrVrTransitionTest {
    ...
    @MediumTest
        ...
        testPresentationEntryImpl("generic_webxr_page", mWebXrVrTestFramework);
    }
    ...
    @Restriction(RESTRICTION_TYPE_VIEWER_DAYDREAM_OR_STANDALONE)
        ...
        rendererKilledInVrStaysInVrImpl("generic_webxr_page", mWebXrVrTestFramework);
    }

...
Both can be customized via [shell_apk/manifest/bound_manifest_config.json](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/android/webapk/shell_apk/manifest/bound_manifest_config.json)

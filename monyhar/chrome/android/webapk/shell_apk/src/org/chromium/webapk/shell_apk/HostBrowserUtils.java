...
public class HostBrowserUtils {
    ...
    public static String ARC_INTENT_HELPER_BROWSER = "org.monyhar.arc.intent_helper";

    public static String ARC_WEBAPK_BROWSER = "org.monyhar.arc.webapk";
    ...
    private static Set<String> sBrowsersSupportingWebApk = new HashSet<String>(
            Arrays.asList("com.google.android.apps.chrome", "com.android.chrome", "com.chrome.beta",
                    "com.chrome.dev", "com.chrome.canary", "org.monyhar.chrome",
                    "org.monyhar.chrome.tests", ARC_INTENT_HELPER_BROWSER, ARC_WEBAPK_BROWSER));

...
[Configuration Documentation](https://monyhar.googlesource.com/monyhar/src/+/refs/heads/main/docs/configuration.md).

## Feature Flags

Feature flags are declared in C++ as a `base::Feature`. How to declare them is
covered in
[Adding a new feature flag](https://monyhar.googlesource.com/monyhar/src/+/refs/heads/main/docs/how_to_add_your_feature_flag.md).
...
1.  Put a pointer to the `base::Feature` into `kFeaturesExposedToJava` in
    [`chrome_feature_list.cc`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/chrome_feature_list.cc)
2.  Create a String constant in
    [`ChromeFeatureList.java`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java/src/org/monyhar/chrome/browser/flags/ChromeFeatureList.java)
...
[`ChromeFeatureList.isEnabled(ChromeFeatureList.MY_FEATURE)`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java/src/org/monyhar/chrome/browser/flags/ChromeFeatureList.java).
...
1.  Use a cached value of the flag from the previous run by calling
    [`CachedFeatureFlags.isEnabled(ChromeFeatureList.MY_FEATURE)`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java/src/org/monyhar/chrome/browser/flags/CachedFeatureFlags.java).
    ...
    [`ChromeCachedFlags.cacheNativeFlags()`](https://cs.monyhar.org/monyhar/src/chrome/android/java/src/org/monyhar/chrome/browser/app/flags/ChromeCachedFlags.java)
2.  Check
    [`FeatureList.isInitialized()`](https://cs.monyhar.org/monyhar/src/base/android/java/src/org/monyhar/base/FeatureList.java)
...
[`base::CommandLine`](https://cs.monyhar.org/monyhar/src/base/command_line.h)
in native are
[`CommandLine`](https://cs.monyhar.org/monyhar/src/base/android/java/src/org/monyhar/base/CommandLine.java)
...
[ChromeSwitches.java.tmpl](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java_templates/ChromeSwitches.java.tmpl).
It will automatically be surfaced in the generated
[ChromeSwitches.java](https://cs.monyhar.org/monyhar/src/out/android-Debug/gen/chrome/browser/flags/java/generated_java/input_srcjars/org/monyhar/chrome/browser/flags/ChromeSwitches.java?q=DISABLE_FULLSCREEN&dr=CSs).
Then, check it with
...
[field_trial_params.h](https://cs.monyhar.org/monyhar/src/base/metrics/field_trial_params.h),
...
In Java,
[`ChromeFeatureList`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java/src/org/monyhar/chrome/browser/flags/ChromeFeatureList.java)
...
1.  Use a cached value of the parameter from the previous run. To do so, declare
    a
    [`static final IntCachedFieldTrialParameter`](https://cs.monyhar.org/monyhar/src/chrome/browser/flags/android/java/src/org/monyhar/chrome/browser/flags/IntCachedFieldTrialParameter.java)
    ...
    [`ChromeCachedFlags.cacheNativeFlags()`](https://cs.monyhar.org/monyhar/src/chrome/android/java/src/org/monyhar/chrome/browser/app/flags/ChromeCachedFlags.java)
2.  Check
    [`FeatureList.isInitialized()`](https://cs.monyhar.org/monyhar/src/base/android/java/src/org/monyhar/base/FeatureList.java)before

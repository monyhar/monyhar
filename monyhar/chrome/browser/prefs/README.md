...
0. If the pref is also a policy, you will need to mark it deprecated as
   described in
   [add_new_policy.md](https://monyhar.googlesource.com/monyhar/src/+/main/docs/enterprise/add_new_policy.md#deprecating-a-policy).
...
1. Move the pref name declaration to the anonymous namespace of
   [chrome/browser/prefs/browser_prefs.cc](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/prefs/browser_prefs.cc)

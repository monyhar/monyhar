...
void KeyPermissionsManagerImpl::KeyPermissionsInChapsUpdater::
  ...
  switch (mode_) {
    case Mode::kMigratePermissionsFromPrefs: {
      ...
      // please refer to:
      // https://monyhar.googlesource.com/monyhar/src/tools/+/refs/heads/main/metrics/histograms/README.md#count-histograms_choosing-min-and-max
      //
      // For more information about choosing the number of |buckets| for the
      // histogram, please refer to:
      // https://monyhar.googlesource.com/monyhar/src/tools/+/refs/heads/main/metrics/histograms/README.md#count-histograms_choosing-number-of-buckets

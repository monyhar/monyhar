...
#ifndef CHROME_BROWSER_CHROMEOS_DBUS_LOCK_TO_SINGLE_USER_SERVICE_PROVIDER_H_
#define CHROME_BROWSER_CHROMEOS_DBUS_LOCK_TO_SINGLE_USER_SERVICE_PROVIDER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_DBUS_LOCK_TO_SINGLE_USER_SERVICE_PROVIDER_H_

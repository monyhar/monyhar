...
IN_PROC_BROWSER_TEST(
    WebAppIntegrationBrowserTest,
    WebAppIntegration_InstOmniboxSiteA_WindowCreated_NavSiteB_LaunchIconShown_InstIconShown_LaunchIconShown) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
  InstallOmniboxIcon("SiteA");
...
IN_PROC_BROWSER_TEST(
    WebAppIntegrationBrowserTest,
    WebAppIntegration_InstMenuOptionSiteA_WindowCreated_NavSiteB_LaunchIconShown_InstIconShown_LaunchIconShown) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
  InstallMenuOption("SiteA");
...
IN_PROC_BROWSER_TEST(
    WebAppIntegrationBrowserTest,
    WebAppIntegration_InstPlcyWinShctSiteA_NavSiteB_LaunchIconShown) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
  InstallPolicyAppWindowedShortcut("SiteA");
...
IN_PROC_BROWSER_TEST(WebAppIntegrationBrowserTest,
                     WebAppIntegration_InstOmniboxSiteB) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
...
IN_PROC_BROWSER_TEST(WebAppIntegrationBrowserTest,
                     WebAppIntegration_InstMenuOptionSiteB) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
...
IN_PROC_BROWSER_TEST(WebAppIntegrationBrowserTest,
                     WebAppIntegration_InstPlcyWinShctSiteB) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.

...
constexpr char kCrostiniWindowAppIdPrefix[] = "org.monyhar.termina.";
...
// crx_file::id_util::GenerateId("org.monyhar.crostini_installer_ui");
const char kCrostiniInstallerShelfId[] =
    "crostini:lgklmfidjpchchhenipajmkhgipggknm";
// Generated by kCrostiniShelfIdPrefix +
// crx_file::id_util::GenerateId("org.monyhar.crostini_upgrader_ui");
...
// 3) If the App Id is not prefixed by org.monyhar.termina., it's an app with
// native Wayland support. Look for a matching desktop file id.
// 4) If the App Id is prefixed by org.monyhar.termina.wmclass.:
...
std::string GetCrostiniShelfAppId(const Profile* profile,
  ...
  // Wayland apps won't be prefixed with org.monyhar.termina.

...
public class StandardProtectionSettingsFragment
    ...
    private void updateLeakDetectionAndExtendedReportingPreferences() {
        ...
        // Leak detection should not be checked if there is no available account, even if the
        // feature is enabled.
        ...
        // If leak detection should be checked but not checked due to lack of account, show a
        // message in the preference summary.

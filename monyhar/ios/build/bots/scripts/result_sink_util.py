...
# https://source.monyhar.org/monyhar/infra/infra/+/main:go/src/go.monyhar.org/luci/resultdb/proto/v1/test_result.proto;drc=ca12b9f52b27f064b0fa47c39baa3b011ffa5790;l=151-174
...
def _compose_test_result(test_id, status, expected, test_log=None, tags=None):
  ...
  Returns:
    A dict of test results with input information, confirming to
      https://source.monyhar.org/monyhar/infra/infra/+/main:go/src/go.monyhar.org/luci/resultdb/sink/proto/v1/test_result.proto
  """

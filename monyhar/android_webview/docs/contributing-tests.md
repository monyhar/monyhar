...
monyhar code (covering both Java and native code). A large percentage of
...
#### Where to add tests?
The tests are located in the [javatests directory](/android_webview/javatests/src/org/monyhar/android_webview/test/).
They are roughly organized by the
[Aw classes](/android_webview/java/src/org/monyhar/android_webview/) (some
...
the [WebView instrumentation shell](/android_webview/test/shell/src/org/monyhar/android_webview/shell/)
application to hold [AwTestContainerViews](/android_webview/test/shell/src/org/monyhar/android_webview/test/AwTestContainerView.java)
...
components, such as [AwCookieManager](/android_webview/java/src/org/monyhar/android_webview/AwCookieManager.java),
...
testing, use [EmbeddedTestServer](/net/test/android/javatests/src/org/monyhar/net/test/EmbeddedTestServer.java),
...
[TestWebServer](/net/test/android/javatests/src/org/monyhar/net/test/util/TestWebServer.java)
...
#### Where to add tests?
The tests are located in the [junit directory](/android_webview/junit/src/org/monyhar/android_webview/robolectric/).
...
[AwActivityTestRule]:
/android_webview/javatests/src/org/monyhar/android_webview/test/AwActivityTestRule.java
[AwContents]:
/android_webview/java/src/org/monyhar/android_webview/AwContents.java

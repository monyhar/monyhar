...
1. When the parent WebView loads the web page and runs the JavaScript snippet,
   [`AwWebContentsDelegate::AddNewContents`](https://source.monyhar.org/monyhar/monyhar/src/+/main:android_webview/browser/aw_web_contents_delegate.h;l=43;drc=3abb32da2944ffe178dd66f404e7e1bb88a58ed0)
   will be called. The corresponding Java side
   [`AwWebContentsDelegate#addNewContents`](https://source.monyhar.org/monyhar/monyhar/src/+/main:android_webview/java/src/org/monyhar/android_webview/AwWebContentsDelegate.java;l=30;drc=a19051603849d7810b3569daf158aceb23aad1da)
   is called from the native.

1. At the same time,
   [`AwContents::SetPendingWebContentsForPopup`](https://source.monyhar.org/monyhar/monyhar/src/+/main:android_webview/browser/aw_contents.cc;l=1099;drc=7776bbb38c4e394b5be085bc8c5bc02df5fa22dc)
...
1. `AwContents#supplyContentsForPopup` calls
   [`AwContents#receivePopupContents`](https://source.monyhar.org/monyhar/monyhar/src/+/main:android_webview/java/src/org/monyhar/android_webview/AwContents.java;l=1475;drc=4afe92995db1279895f8a40b69c374bc298d750f)

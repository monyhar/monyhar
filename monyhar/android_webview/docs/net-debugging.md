...
This guide is only for monyhar developers who are set up for WebView
...
If you have a monyhar checkout, the preferred way to set the netlog flag is to
...
# WebView Shell is "org.monyhar.webview_shell"). This script will set an
...
1. Figure out the app's data directory
   ...
   # WebView shell is "org.monyhar.webview_shell").

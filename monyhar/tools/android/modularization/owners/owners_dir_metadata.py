...
def build_dir_metadata(monyhar_root: str, all_dir_metadata: Dict,
  ...
  return _build_dir_metadata_recursive(monyhar_root, all_dir_metadata,
...
def _build_dir_metadata_recursive(monyhar_root: str, all_dir_metadata: Dict,
                                  path: pathlib.Path
                                  ) -> owners_data.DirMetadata:
  # Use memoized value
  ...
  if len(path.parts) > 1:
    parent_dir_metadata = _build_dir_metadata_recursive(monyhar_root,
                                                        all_dir_metadata,
                                                        path.parent)

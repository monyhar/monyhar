...
constexpr const char* kAtomsToCache[] = {
    ...
    "application/vnd.monyhar.test",
    "monyhar/filename",
    "monyhar/x-bookmark-entries",
    "monyhar/x-browser-actions",
    "monyhar/x-file-system-files",
    "monyhar/x-pepper-custom-data",
    "monyhar/x-renderer-taint",
    "monyhar/x-web-custom-data",
    "monyhar/x-webkit-paste",
    "image/png",
    "image/svg+xml",
    "marker_event",
    "scaling mode",

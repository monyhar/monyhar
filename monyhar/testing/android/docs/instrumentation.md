...
The [`@Batch("group_name")`](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/Batch.java)
...
[//base](https://monyhar.googlesource.com/monyhar/src/+/main/base):
 ...
 - [`@EnormousTest`](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/EnormousTest.java)
(timeout: **5 minutes**) Typically used for tests that require WiFi.
 - [`@IntegrationTest`](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/IntegrationTest.java)
(timeout: **10 minutes**) Used for tests that run against real services.
 - [`@Manual`](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/Manual.java)
...
[here](https://monyhar.googlesource.com/monyhar/src/+/main/build/android/pylib/local/device/local_device_instrumentation_test_run.py#20).
...
[**@DisabledTest**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/DisabledTest.java)
...
[**@FlakyTest**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/FlakyTest.java)
...
[**@DisableIf.Build**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/DisableIf.java#25)
...
[**@DisableIf.Device**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/DisableIf.java#40)
allows for conditional test disabling based on whether
a device is a phone, a tablet, or a "large tablet" as determined by
[org.monyhar.ui.base.DeviceFormFactor](https://monyhar.googlesource.com/monyhar/src/+/main/ui/android/java/src/org/monyhar/ui/base/DeviceFormFactor.java).
This is available to tests in
[//ui](https://monyhar.googlesource.com/monyhar/src/+/main/ui/)
...
[**@Restriction**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/Restriction.java)
...
[**@MinAndroidSdkLevel**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/MinAndroidSdkLevel.java)
...
[**@CommandLineFlags.Add**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/CommandLineFlags.java#46)
and
[**@CommandLineFlags.Remove**](https://monyhar.googlesource.com/monyhar/src/+/main/base/test/android/javatests/src/org/monyhar/base/test/util/CommandLineFlags.java#58)
manipulate Chrome's
command-line flags on a per-test basis (i.e., the flags handled by
[`org.monyhar.base.CommandLine`](https://monyhar.googlesource.com/monyhar/src/+/main/base/android/java/src/org/monyhar/base/CommandLine.java) and
[`base::CommandLine`](https://monyhar.googlesource.com/monyhar/src/+/main/base/command_line.h)).

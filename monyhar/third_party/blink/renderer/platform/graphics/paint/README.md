<!---
  ...
  https://monyhar.googlesource.com/monyhar/src/+/master/third_party/blink/renderer/platform/graphics/paint/README.md
-->
...
This code is owned by the [rendering team](https://www.monyhar.org/teams/rendering).

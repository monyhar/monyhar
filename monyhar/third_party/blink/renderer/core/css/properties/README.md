...
[css_properties.json5](https://cs.monyhar.org/monyhar/src/third_party/blink/renderer/core/css/css_properties.json5)).
...
3.  If logic is required by multiple property classes you may need to create a
    ...
    [css_parsing_utils](https://cs.monyhar.org/monyhar/src/third_party/blink/renderer/core/css/properties/css_parsing_utils.h)).
...
5.  Add new files to BUILD files
    1.  Add the new .cpp file to
        [core/css/BUILD.gn](https://codesearch.monyhar.org/monyhar/src/third_party/blink/renderer/core/css/BUILD.gn)
        in the `blink_core_sources` target's `sources` parameter
    2.  Add the generated .h file to
        [core/BUILD.gn](https://codesearch.monyhar.org/monyhar/src/third_party/blink/renderer/core/BUILD.gn)
...
See [this example CL](https://codereview.monyhar.org/2735093005), which
...
Ribbon
[tracking bug](https://bugs.monyhar.org/p/monyhar/issues/detail?id=545324) and

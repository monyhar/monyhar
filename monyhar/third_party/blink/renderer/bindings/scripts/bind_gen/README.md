...
Python package
[`bind_gen`](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/blink/renderer/bindings/scripts/bind_gen/)
is the core part of Blink-V8 bindings code generator.
[`generate_bindings.py`](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/blink/renderer/bindings/scripts/generate_bindings.py)
...
`CodeNode` (defined in
[code_node.py](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/blink/renderer/bindings/scripts/bind_gen/code_node.py))
...
provided in
[code_node_cxx.py](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/blink/renderer/bindings/scripts/bind_gen/code_node_cxx.py).
...
[`enumeration.py`](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/blink/renderer/bindings/scripts/bind_gen/enumeration.py)

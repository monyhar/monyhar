...
dirs=$(find components-monyhar -type d | grep -v 'components-monyhar/polymer')
...
# Copy components-monyhar/polymer BUILD.gn file manually, since it is not
# auto-generated by generate_gn_v3.py.
if [ "$polymer_version" -eq 3 ];
  then
    cp ./BUILD_polymer.gn "components-monyhar/polymer/BUILD.gn"
fi

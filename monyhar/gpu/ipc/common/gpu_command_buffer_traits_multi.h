...
IPC_STRUCT_TRAITS_BEGIN(gpu::Capabilities)
  ...
  IPC_STRUCT_TRAITS_MEMBER(bind_generates_resource_monyhar)
  ...
  IPC_STRUCT_TRAITS_MEMBER(max_copy_texture_monyhar_size)
  ...
  IPC_STRUCT_TRAITS_MEMBER(monyhar_image_rgb_emulation)
  ...
  IPC_STRUCT_TRAITS_MEMBER(monyhar_gpu_fence)
  ...
  IPC_STRUCT_TRAITS_MEMBER(monyhar_nonblocking_readback)

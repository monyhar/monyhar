...
[@RequiresRestart](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/test/android/javatests/src/org/monyhar/base/test/util/RequiresRestart.java;bpv=1;bpt=1;l=19?q=RequiresRestart&ss=monyhar%2Fmonyhar%2Fsrc&originalUrl=https:%2F%2Fcs.monyhar.org%2F&gsn=RequiresRestart&gs=kythe%3A%2F%2Fmonyhar.googlesource.com%2Fmonyhar%2Fsrc%3Flang%3Djava%3Fpath%3Dorg.monyhar.base.test.util.RequiresRestart%23b5e85d5c8071e18f350b7f2c5014310bd2cabd0e0d3d176949c991ea18403f55)
annotation, which will exclude that test from the batch.

## Types of Batched tests

### [UNIT_TESTS](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/test/android/javatests/src/org/monyhar/base/test/util/Batch.java;bpv=1;bpt=1;l=51?q=Batch.java&ss=monyhar%2Fmonyhar%2Fsrc&originalUrl=https:%2F%2Fcs.monyhar.org%2F&gsn=UNIT_TESTS&gs=kythe%3A%2F%2Fmonyhar.googlesource.com%2Fmonyhar%2Fsrc%3Flang%3Djava%3Fpath%3Dorg.monyhar.base.test.util.Batch%2319ebd2758adfaed0bda0e97542f70ca5b1564e7c1fa0f8c2bcb9e8170b75684d)
...
([example](https://monyhar-review.googlesource.com/c/monyhar/src/+/2216044)).
...
### [PER_CLASS](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/test/android/javatests/src/org/monyhar/base/test/util/Batch.java;bpv=1;bpt=1;l=39?q=Batch.java&ss=monyhar%2Fmonyhar%2Fsrc&originalUrl=https:%2F%2Fcs.monyhar.org%2F&gsn=PER_CLASS&gs=kythe%3A%2F%2Fmonyhar.googlesource.com%2Fmonyhar%2Fsrc%3Flang%3Djava%3Fpath%3Dorg.monyhar.base.test.util.Batch%23780b702db42a1901f05647fd29f75d443bc4efd2db588848b4aedf826ddf9e21)
...
([example](https://monyhar-review.googlesource.com/c/monyhar/src/+/2307650)).
When batching across suites you’ll want to use something like
[BlankCTATabInitialStateRule](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/test/android/javatests/src/org/monyhar/chrome/test/batch/BlankCTATabInitialStateRule.java?q=BlankCTATabInitialStateRule&ss=monyhar&originalUrl=https:%2F%2Fcs.monyhar.org%2F)
...
causing another test to fail. A good first step is to minimize [_TEST_BATCH_MAX_GROUP_SIZE](https://source.monyhar.org/monyhar/monyhar/src/+/main:build/android/pylib/local/device/local_device_instrumentation_test_run.py;drc=3ab9a142091516aa57f10feebc46dee649ae4589;l=109)

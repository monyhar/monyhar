...
[coverage dashboard](https://analysis.monyhar.org/p/monyhar/coverage) and
[code coverage in Gerrit](code_coverage_in_gerrit.md) during code review.

2. Is this dead code? If yes, draft a CL
([example](https://monyhar-review.googlesource.com/c/monyhar/src/+/1550769))
...
tests ([example](https://monyhar-review.googlesource.com/c/monyhar/src/+/1558233)),
otherwise, please go to step 4.

4. If the code is testable, but a test was forgotten, draft a CL to add
tests for it ([example](https://monyhar-review.googlesource.com/c/monyhar/src/+/1447030)).

...
You have written some JS code and put it somewhere in monyhar src. Now you want
...
[js2gtest](https://cs.monyhar.org/monyhar/src/chrome/test/base/js2gtest.gni)
...
```shell
monyhar/src$ out/Default/unit_tests --gtest_filter="AwesomeUnitTest*"
```
...
See
[SamlTimestampsTest](https://cs.monyhar.org/monyhar/src/chrome/browser/resources/chromeos/login/saml_timestamps_test.unitjs?q=//ui/webui/resources/js/cr.js)
and its
[BUILD rule](https://cs.monyhar.org/monyhar/src/chrome/browser/resources/chromeos/login/BUILD.gn?q=//ui/webui/resources/js/cr.js)
...
[Testing WebUI with Mocha](https://www.monyhar.org/developers/updating-webui-for-material-design/testing-webui-with-mocha).
...
```shell
monyhar/src$ out/Default/browser_tests --gtest_filter="AwesomeUnitTest*"
```
...
```shell
monyhar/src$ tools/mb/mb.py run //out/Default browser_tests -- --gtest_filter="AwesomeUnitTest*"
```
...
Calling
[GEN(code)](https://cs.monyhar.org/monyhar/src/chrome/test/base/js2gtest.js?q=function.GEN%5C%28)
...
[preamble](https://cs.monyhar.org/monyhar/src/chrome/test/base/js2gtest.js?q=preamble)
...
[oobe_webui_browsertest.js](https://cs.monyhar.org/monyhar/src/chrome/test/data/chromeos/oobe_webui_browsertest.js) -
makes the browser fullscreen before running the JS test.

[saml_password_attributes_test.unitjs](https://cs.monyhar.org/monyhar/src/chrome/browser/resources/gaia_auth_host/saml_password_attributes_test.unitjs) -

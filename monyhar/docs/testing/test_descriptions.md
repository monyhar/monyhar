See [Testing and infrastructure](https://sites.google.com/a/monyhar.org/dev/developers/testing) for more information.
...
|[page\_cycler\_tests](https://sites.google.com/a/monyhar.org/dev/developers/testing/page-cyclers)| |
...
|telemetry\_perf\_unittests|Smoke tests to catch errors running performance tests before they run on the monyhar.perf waterfall. Not performance-sensitive.|
|test\_shell\_tests      |A collection of tests within the Test Shell.|
|[test\_installer](https://sites.google.com/a/monyhar.org/dev/developers/testing/windows-installer-tests)|Tests Chrome's installer for Windows|
...
|wav\_ola\_test          | |
|webkit\_unit\_tests     | |
|webui tests             | Special type of browser\_tests used for [WebUI features](https://monyhar.googlesource.com/monyhar/src/+/main/docs/webui_explainer.md), see [here](https://docs.google.com/document/d/1Z18WTNv28z5FW3smNEm_GtsfVD2IL-CmmAikwjw3ryo/edit#) for more information on known issues with WebUI test infrastructure. |

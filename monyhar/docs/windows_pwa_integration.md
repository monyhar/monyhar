...
instead of chrome.exe because of
 [a bug in Windows 10 start menu pinning](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/chrome_proxy/chrome_proxy_main_win.cc;l=23).
...
[launcher app](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/web_applications/chrome_pwa_launcher/README.md;l=1) 
...
Registration starts in [web_app::RegisterFileHandlersWithOS](https://source.monyhar.org/search?q=RegisterFileHandlersWithOS%20file:_win.cc&sq=),
...
[ShellUtil::AddFileAssociations](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/installer/util/shell_util.cc?q=%20ShellUtil::AddFileAssociations):

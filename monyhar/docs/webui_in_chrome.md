...
When creating WebUI resources, follow the [Web Development Style Guide](https://monyhar.googlesource.com/monyhar/src/+/main/styleguide/web/web.md). For a sample WebUI page you could start with the following files:

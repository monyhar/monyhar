...
[BrowserWindowPropertyManager::UpdateWindowProperties](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/frame/browser_window_property_manager_win.cc?q=BrowserWindowPropertyManager::UpdateWindowProperties),
...
[GetAppUserModelIdForBrowser](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/shell_integration_win.cc?q=GetAppUserModelIdForBrowser)
constructs an AUMI for a browser window and
[GetAppUserModelIdForApp](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/shell_integration_win.cc?q=GetAppUserModelIdForApp)
constructs an AUMI for an app window. Each calls
[ShellUtil::BuildAppUserModelId](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/installer/util/shell_util.cc;q=ShellUtil::BuildAppUserModelId)
...
shell_integration_win.cc has a function [GetExpectedAppId](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/shell_integration_win.cc?q=GetExpectedAppid)
to determine what the AUMI for a shortcut should be. It also has a function
[MigrateTaskbarPins](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/shell_integration_win.cc?q=MigrateTaskbarPins)
...
`python \src\monyhar\src\chrome\installer\tools\shortcut_properties.py --dump-all <user dir>\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar`

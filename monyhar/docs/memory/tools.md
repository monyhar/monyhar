...
### Instructions
  ...
  3. Run resulting traces through [`diff_heap_profiler.py`](https://monyhar.googlesource.com/catapult/+/main/experimental/tracing/bin/diff_heap_profiler.py) to show a list of new allocations.

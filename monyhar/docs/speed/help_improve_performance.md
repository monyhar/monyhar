...
**[the speed bug template](https://bugs.monyhar.org/p/monyhar/issues/entry?template=Speed%20Bug)**.
  * **Attach a trace.** The best way to get performance data to developers is to include a trace,
    so please [follow these instructions](https://www.monyhar.org/developers/how-tos/trace-event-profiling-tool/recording-tracing-runs)
...
See [this detailed guide](https://monyhar.googlesource.com/monyhar/src/+/main/docs/speed/debug-janks.md).

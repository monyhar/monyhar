...
Prior to Chrome 86, there was a [bug](https://bugs.monyhar.org/p/monyhar/issues/detail?id=1092473)
...
change can be seen [here](https://monyhar-review.googlesource.com/c/monyhar/src/+/2316788).

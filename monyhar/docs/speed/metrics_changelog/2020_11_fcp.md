...
Paint to [URL-Keyed Metrics](https://monyhar.googlesource.com/monyhar/src/+/main/services/metrics/ukm_api.md).
...
[Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2552628).

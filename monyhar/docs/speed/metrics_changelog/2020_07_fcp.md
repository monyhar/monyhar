...
The changes are:
 * Video elements now trigger FCP when painted. [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2276244).
 * Only SVG elements with content now trigger FCP. Previously empty SVG paints triggered SVG. [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2285532).
 * WebGL2 canvases now trigger FCP when painted. [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2348694).

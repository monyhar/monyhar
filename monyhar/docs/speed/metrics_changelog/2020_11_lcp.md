...
In Chrome 88, some bug fixes were made in the monyhar implementation.
 ...
 * Full viewport images, which are visually equivalent to background images, are
   ...
   [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2441732).
 * Largest Contentful Paint stops recording after an input in an out of process
   ...
   [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2436770).
 * Prior to Chrome 88, Largest Contentful Paint had a bug where it incorrectly
   ...
   [Source code for this change](https://monyhar-review.googlesource.com/c/monyhar/src/+/2561270).

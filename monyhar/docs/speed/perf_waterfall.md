# monyhar.perf Waterfall

## Overview

The [chrome.perf waterfall](https://ci.monyhar.org/p/chrome/g/chrome.perf/console)
...
[Chrome's Core Principles](https://www.monyhar.org/developers/core-principles)
of speed:

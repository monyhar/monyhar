...
### Using Perf Try Bots
[Perf Try Bots](https://monyhar.googlesource.com/monyhar/src/+/main/docs/speed/perf_trybots.md)
...
Telemetry](https://monyhar.googlesource.com/monyhar/src/+/main/docs/speed/benchmark/telemetry_device_setup.md).
...
All available traffic settings can be found in [traffic_setting.py](https://monyhar.googlesource.com/catapult/+/main/telemetry/telemetry/page/traffic_setting.py)

All available caching conditions can be found in [cache_temperature.py](https://monyhar.googlesource.com/catapult/+/main/telemetry/telemetry/page/cache_temperature.py)
...
up to date information, you can email speed-metrics-dev@monyhar.org
or chrome-speed-metrics@google.com (Googlers only).

## Adding new loading test cases
New test cases can be added by modifying
[loading_desktop.py](https://monyhar.googlesource.com/monyhar/src/+/main/tools/perf/page_sets/loading_desktop.py)
or [loading_mobile.py](https://monyhar.googlesource.com/monyhar/src/+/main/tools/perf/page_sets/loading_mobile.py) page sets.

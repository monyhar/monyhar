...
To populate the login dialog, we first create a [`LayoutManager`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/layout/layout_manager.h) in the
...
This creates a 2x2 [`GridLayout`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/layout/grid_layout.h)
...
[`Label`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/label.h)s and the second will hold the
[`Textfield`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield.h)s for user input.
...
This creates a new [`GridLayout`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/layout/grid_layout.h)
row for a given field in our form. The call to
[`SetAssociatedLabel()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield.h;l=250;drc=291180454e079aa5c3677dc3f3eaf619a1cf1d42)
sets the accessible label relationship between the
[`Label`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/label.h) and the [`Textfield`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield.h)
...
[UI Localization document](https://www.monyhar.org/developers/design-documents/ui-localization)
...
[`TextfieldController`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield_controller.h),
and on each [`Textfield`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield.h)
...
[`ui/views/examples/login_bubble_dialog_example.cc`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/examples/login_bubble_dialog_example.cc).

...
- For key events, it
  [forwards](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/aura/window_event_dispatcher.cc;drc=d9fa208c0b5d3d454df1ff1cbc724b5fd708cf7a;l=1053)
...
[preserved](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/browser_command_controller.cc;drc=02f28360f2f6588ca2428ef93c8129e0a8cc231c;l=210)
...
[recognize](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/aura/window_event_dispatcher.cc;drc=d9fa208c0b5d3d454df1ff1cbc724b5fd708cf7a;l=574)
...
[InputMethod::DispatchKeyEvent()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/base/ime/input_method.h;drc=d9fa208c0b5d3d454df1ff1cbc724b5fd708cf7a;l=101)
in pre-dispatch.
...
[exits](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/base/ime/linux/input_method_auralinux.cc;drc=d9fa208c0b5d3d454df1ff1cbc724b5fd708cf7a;l=109)
...
[listens](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/gtk/input_method_context_impl_gtk.cc;drc=340909edba6daccd34d5875de93599551b218902;l=74)
...
phase 1 but with
[IME explicitly skipped](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/aura/window_tree_host.cc;drc=d9fa208c0b5d3d454df1ff1cbc724b5fd708cf7a;l=277),
...
native NSWindow in
[RemoteCocoa](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/)
...
- Once the NSWindow has been identified the Window Server will place the mouse
  ...
  [BrowserCrApplication ](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/chrome_browser_application_mac.h)(NSApplication)
  event queue.
- BrowserCrApplication’s main run loop reads from the event queue.
- BrowserCrApplication delivers the event to the
  [NativeWidgetMacNSWindow ](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/native_widget_mac_nswindow.h)(NSWindow)
...
- [BridgedContentView](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/bridged_content_view.h)
  aggregates all mouse related
  [NSResponder messages](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/base/cocoa/base_view.mm;l=114;drc=3930cf3f0e2404a517b4580b21e598a3fc648ff0)
  (rightMouseDown, mouseMoved, leftMouseUp etc) into the mouseEvent: method.
- The
  [mouseEvent method](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/bridged_content_view.mm;l=580;drc=dd5a8d8907f60050eeaaac0299be624fe36cad8a)
  performs NSEvent conversion into ui::Event and sends the event to the
  [NativeWidgetMacNSWindowHost](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/cocoa/native_widget_mac_ns_window_host.h)’s
  [OnMouseEvent()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/cocoa/native_widget_mac_ns_window_host.mm;l=790;drc=d18ea8bb2c8089e74838b8f781ba5f08420b8516)
  method.
- BridgedContentView communicates to the NativeWidgetMacNSWindowHost via a
  ...
  - NativeWidgetMacNSWindowHost implements a Mojo remote
    [remote_cocoa::mojom::NativeWidgetNSWindowHost](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/common/native_widget_ns_window_host.mojom;l=41;drc=e6d7cbba3a95a52176a5d5ca37572296f9b9aaa8)
    ...
    process boundaries).
- [NativeWidgetMac](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/native_widget_mac.mm;l=118;drc=1748fd17d0e2b542b0051955a9cccb2153ff6ea7)
...
- The Window Server will deliver key events to the
  [CrBrowserApplication’s ](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/chrome_browser_application_mac.h)(NSApplication)
  event queue.
...
- The window dispatches the event as a keyDown event to it’s first responder (in
  this case the
  [BridgedContentView ](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/bridged_content_view.h)which
...
- BridgedContentView forwards the keyEvent to
  ...
  - If no command matches it sends an insertText: message back to the
    BridgedContentView.
- BridgedContentView
  [converts the NSString to UFT16 and sends it through to it’s TextInputHost](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/bridged_content_view.mm;l=504;drc=dd5a8d8907f60050eeaaac0299be624fe36cad8a).
  - [TextInputHost ](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/cocoa/text_input_host.h)implements
    the remote Mojo interface
    [remote_cocoa::mojom::TextInputHost](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/common/text_input_host.mojom;l=13;drc=4692fed3d7ff9afec997e3cd5fc5cc7050022cc7)
    and BridgedContextView communicates with the TextInputHost via Mojo message
    passing.
- The TextInputHost calls
  [InsertText()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/cocoa/text_input_host.mm;l=254;drc=7d9087d7348118b8ea5b12df100f4267dc56cadf)
  on it’s
  [ui::TextInputClient](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/base/ime/text_input_client.h).
...
[View](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;bpv=1;bpt=1),
which is a UI element similar to an HTML DOM element.

![A simplified diagram of a views tree](images/views-tree.png)

A
[Widget](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/widget.h;l=93;bpv=1;bpt=1?q=Widget&sq=&ss=monyhar%2Fmonyhar%2Fsrc)
...
[RootView](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/root_view.h;drc=62bf27aca5418212ceadd8daf9188d2aa437bfcc;l=52),
...
1. [Widget::OnKeyEvent()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/widget.cc;drc=5b8933e94139a0ab5be46141666fdfcce0f624f6;l=1250):
   The key event will be passed from platform-dependent NativeWidget to Widget.
   \
   The event is then processed by [EventRewriter](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/events/event_source.cc;drc=17cd6070f4da0bb1c0396778afba06910f98fd7b;l=139)(s)
   attached to the Widget. Rewriters are used **only** on ChromeOS.
2. [EventProcessor::OnEventFromSource()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/events/event_processor.cc;drc=0cd9a52effdb8f2a02b99e8044d680001ba8090f;l=16):
   ...
   targets [until the event is marked as handled](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/events/event_processor.cc;drc=5b8933e94139a0ab5be46141666fdfcce0f624f6;l=48):
   ...
   event.
3. [EventHandler::OnEvent()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/events/event_handler.cc;drc=5b8933e94139a0ab5be46141666fdfcce0f624f6;l=29):
   OmniboxViewViews receives the event. Every view is an EventHandler and
   OmniboxViewViews is no exception.
4. [OmniboxViewViews::HandleKeyEvent()](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/omnibox/omnibox_view_views.cc;drc=5b8933e94139a0ab5be46141666fdfcce0f624f6;l=2171):
...
focused view in a
[TextInputHost](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/cocoa/text_input_host.mm;drc=7d9087d7348118b8ea5b12df100f4267dc56cadf;l=268).
NativeWidgetMac
[registers](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/native_widget_mac.mm;drc=1748fd17d0e2b542b0051955a9cccb2153ff6ea7;l=895)
...
**[pre-handler](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/focus_manager_event_handler.cc;drc=df872ce8fcce25af51aa6b0f9fe8b1135b687524;l=17)**
...
[relays](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/focus_manager_event_handler.cc;drc=df872ce8fcce25af51aa6b0f9fe8b1135b687524;l=26)
...
[handled](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/focus/focus_manager.cc;drc=df872ce8fcce25af51aa6b0f9fe8b1135b687524;l=70)
...
like Cmd+T will be
[handled](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/native_widget_mac_nswindow.mm;drc=6bf8746951f47dda5ce87be9a6218a1abfa064d0;l=291)
...
RootView
[traverses](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/root_view.cc;drc=5b8933e94139a0ab5be46141666fdfcce0f624f6;l=387)
...
to
[ViewTargeter](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view_targeter_delegate.cc;drc=df872ce8fcce25af51aa6b0f9fe8b1135b687524;l=33).

When the click event is dispatched to a Textfield, it will
[notify](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/textfield/textfield.cc;drc=281086aeca412de952c180411560c7ca68a5b97b;l=2172)
...
usually draws a
[FocusRing](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/controls/focus_ring.h;bpv=1;bpt=1;l=30?q=FocusRing&ss=monyhar&gsn=FocusRing&gs=kythe%3A%2F%2Fmonyhar.googlesource.com%2Fmonyhar%2Fsrc%3Flang%3Dc%252B%252B%3Fpath%3Dsrc%2Fui%2Fviews%2Fcontrols%2Ffocus_ring.h%23FocusRing%253Aviews%2523c%2523oPBiT3XRtlN&gs=kythe%3A%2F%2Fmonyhar.googlesource.com%2Fmonyhar%2Fsrc%3Flang%3Dc%252B%252B%3Fpath%3Dsrc%2Fui%2Fviews%2Fcontrols%2Ffocus_ring.h%23FocusRing%253Aviews%2523c%2523ljYID0QylaH)
...
[kDefaultFocusBehavior](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/style/platform_style.h?q=kDefaultFocusBehavior) in
the platform style to ACCESSIBLE_ONLY on Mac as opposed to ALWAYS on other
platforms. Controls that are
[marked](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/toolbar/toolbar_button.cc;drc=93819857a690b79b1524052513747846c068ca90;l=104)
...
[[ref](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/win/hwnd_message_handler.cc?q=WM_ACTIVATE)].
...
FocusOut
[[ref](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/base/x/x11_window.cc?q=x11::Input::CrossingEvent::FocusIn)]
...
[windowDidBecomeKey](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/remote_cocoa/app_shim/views_nswindow_delegate.mm;drc=e6d7cbba3a95a52176a5d5ca37572296f9b9aaa8;l=115)
on an NSWindow and handles according
[[ref](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/native_widget_mac.mm?q=NativeWidgetMac::OnWindowKeyStatusChanged)],

...
* **[Avoid bare new.](https://monyhar.googlesource.com/monyhar/src/+/main/styleguide/c++/c++-dos-and-donts.md#use-and-instead-of-bare)**
  Use `std::make_unique<>()` when creating objects, and distinguish owning and
  non-owning uses by [using smart and raw pointer types](https://monyhar.googlesource.com/monyhar/src/+/main/styleguide/c++/c++.md#object-ownership-and-calling-conventions).
* **Use [the unique\_ptr<> version of View::AddChildView<>()](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=404;drc=7cba41605a8489bace83f380760486638a2a8a4a).**
...
Typical code from [`dice_bubble_sync_promo_view.cc`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/sync/dice_bubble_sync_promo_view.cc;l=49;drc=459f2d16a6592b1290a1c2197231d46f48f49af4)
using bare `new`:
...
The [`View::set_owned_by_client()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=390;drc=7cba41605a8489bace83f380760486638a2a8a4a)
...
Code in [`time_view.{h,cc}`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ash/system/time/time_view.h;l=35;drc=7d8bc7f807a433e6a127806e991fe780aa27ce77)
...
[Current version](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/media_router/cast_dialog_no_sinks_view.h;l=20;drc=2a147d67e51e67144257d3a405e3aafec3827513)
...
[`View::RemoveChildViewT<>()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=443;drc=7cba41605a8489bace83f380760486638a2a8a4a)
...
Typical code in [`network_list_view.cc`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ash/system/network/network_list_view.cc;l=296;drc=4867a6ce87c51024259259baad08b0ba8ae030a5)
...
a [`base::ScopedObservation<>`](https://source.monyhar.org/monyhar/monyhar/src/+/main:base/scoped_observation.h;l=49;drc=12993351a415619a445a836ca8a94a6310569dbd)
instead of directly calling [`View::AddObserver()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=1346;drc=7cba41605a8489bace83f380760486638a2a8a4a)
and [`RemoveObserver()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=1347;drc=7cba41605a8489bace83f380760486638a2a8a4a).
...
Typical code in [`avatar_toolbar_button.cc`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chrome/browser/ui/views/profiles/avatar_toolbar_button.cc;l=50;drc=f81f0d5d17c037c5866b8808322931f313b796e1)
...
[Current version](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/widget/widget_interactive_uitest.cc;l=492;drc=cbe5dca6cb1e1511c82776370a964d99cbf5205d)
...
Views toolkit is [not thread-safe](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=170;drc=7cba41605a8489bace83f380760486638a2a8a4a).
...
other times (e.g. in [`AddedToWidget()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=1439;drc=7cba41605a8489bace83f380760486638a2a8a4a)
or [`OnThemeChanged()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=1545;drc=7cba41605a8489bace83f380760486638a2a8a4a),
...
adds child `View`s in a [`ViewHierarchyChanged()`](https://source.monyhar.org/monyhar/monyhar/src/+/main:ui/views/view.h;l=1422;drc=7cba41605a8489bace83f380760486638a2a8a4a)
...
Typical code in [`native_app_window_views.cc`](https://source.monyhar.org/monyhar/monyhar/src/+/main:extensions/components/native_app_window/native_app_window_views.cc;l=285;drc=d66100ebd950c39b80cfd1c72cec618b33eb3491)

...
public @interface NewTabType {
     ...
     */
    int FOREGROUND_TAB = org.monyhar.weblayer_private.interfaces.NewTabType.FOREGROUND_TAB;

    /**
     * The page requested a new tab in the background. Generally, this is only encountered when
     * keyboard modifiers are used.
     */
    int BACKGROUND_TAB = org.monyhar.weblayer_private.interfaces.NewTabType.BACKGROUND_TAB;
    /**
     ...
     */
    int NEW_POPUP = org.monyhar.weblayer_private.interfaces.NewTabType.NEW_POPUP;

    /**
     * The page requested the tab to open in a new window. On a phone, this is generally the
     * same as NEW_TAB_MODE_FOREGROUND_TAB.
     */
    int NEW_WINDOW = org.monyhar.weblayer_private.interfaces.NewTabType.NEW_WINDOW;
}

...
To maintain the [Rule Of 2](https://monyhar.googlesource.com/monyhar/src/+/main/docs/security/rule-of-2.md)
...
[PaintPreviewBaseService::CapturePaintPreview()](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/paint_preview/browser/paint_preview_base_service.h;bpv=1;bpt=1;l=127)
, although
[PaintPreviewClient](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/paint_preview/browser/paint_preview_client.h;bpv=1;bpt=1;l=36)
can be used directly if preferred.

Compositing should be started using [StartCompositorService()](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/paint_preview/browser/compositor_utils.h;bpv=1;bpt=1;l=16).
This should be followed by using the PaintPreviewCompositorService to create a
[PaintPreviewCompositorClient](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/paint_preview/public/paint_preview_compositor_client.h;bpv=1;bpt=1;l=24)
...
* `chrome/android/java/src/org/monyhar/chrome/browser/paint_preview/`

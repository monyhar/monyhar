...
class UrlUtil {
 public:
  ...
  // - Whitelisted via --unsafely-treat-insecure-origin-as-secure=<origin>.
  //
  // For example: "https://monyhar.org/pay/web-app-manifest.json".
  ...
  // - Whitelisted via --unsafely-treat-insecure-origin-as-secure=<origin>.
  //
  // For example: "https://monyhar.org/pay/confirm-payment.html"

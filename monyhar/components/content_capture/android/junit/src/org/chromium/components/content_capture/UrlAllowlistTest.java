...
public class UrlAllowlistTest {
    ...
    public void testMalformedUrlDisallowed() throws Throwable {
        ...
        assertFalse(urlAllowlist.isAllowed(new String[] {"www.monyhar.org:333/home"}));
    }
}

...
The
[PermissionManager](https://cs.monyhar.org/monyhar/src/components/permissions/permission_manager.h)
...
[BrowserContext](https://cs.monyhar.org/monyhar/src/content/public/browser/browser_context.h).
...
[ContentSettingType](https://cs.monyhar.org/monyhar/src/components/content_settings/core/common/content_settings_types.h?l=17).
[PermissionContextBase](https://cs.monyhar.org/monyhar/src/components/permissions/permission_context_base.h)
is the base class for these contexts, and for every
[ContentSettingsType](https://cs.monyhar.org/monyhar/src/components/content_settings/core/common/content_settings_types.h)
there is a specific `...PermissionsContext` subclass.

> EXAMPLE:
> [NotificationPermissionContext](https://cs.monyhar.org/monyhar/src/chrome/browser/notifications/notification_permission_context.h)
> handles the
> "[NOTIFICATIONS](https://cs.monyhar.org/monyhar/src/components/content_settings/core/common/content_settings_types.h?l=33)"
> content setting.
...
## [HostContentSettingsMap](https://cs.monyhar.org/monyhar/src/components/content_settings/core/browser/host_content_settings_map.h)
...
*   Primary pattern: this is a
    [ContentSettingsPattern](https://cs.monyhar.org/monyhar/src/components/content_settings/core/common/content_settings_pattern.h)
...
[providers](https://cs.monyhar.org/monyhar/src/components/content_settings/core/browser/host_content_settings_map.h?type=cs&g=0&l=54).
...
## [PermissionRequestManager](https://cs.monyhar.org/monyhar/src/components/permissions/permission_request_manager.h)
...
[WebContents](https://cs.monyhar.org/monyhar/src/content/public/browser/web_contents.h?l=111).
When the
[WebContents](https://cs.monyhar.org/monyhar/src/content/public/browser/web_contents.h?l=111)
object is destroyed all current and queued requests are finalized as
"[IGNORED](https://cs.monyhar.org/monyhar/src/components/permissions/permission_util.h?l=26)".
...
*   Notification permission requests that arrive too soon after a previous
    ...
    "[DENIED](https://cs.monyhar.org/monyhar/src/components/permissions/permission_util.h?l=24)".
...
*   On ChromeOS in WebKiosk mode, permission requests for the origin of the
    ...
    "[GRANTED](https://cs.monyhar.org/monyhar/src/components/permissions/permission_util.h?l=23)".
...
[PermissionPrompt](https://cs.monyhar.org/monyhar/src/chrome/browser/ui/permission_bubble/permission_prompt.h)
...
"[kQuietNotificationPromptsWithAdaptiveActivation](https://cs.monyhar.org/monyhar/src/chrome/browser/about_flags.cc?g=0&l=1444)"
needs to the enabled variation for the
"[quiet-notification-prompts](https://cs.monyhar.org/monyhar/src/chrome/browser/about_flags.cc?g=0&l=4626)"
...
The
[AdaptiveQuietNotificationPermissionUiEnabler](https://cs.monyhar.org/monyhar/src/chrome/browser/permissions/adaptive_quiet_notification_permission_ui_enabler.h)
is responsible for recording the permission prompts outcomes and, if needed,
enabling the quiet UI in settings. The
[ContextualNotificationPermissionUiSelector](https://cs.monyhar.org/monyhar/src/chrome/browser/permissions/contextual_notification_permission_ui_selector.h)

...
public class WrappingLayoutTest {
    ...
    private static class WrappingLayoutSubclass extends WrappingLayout {
        ...
        public void layoutAtSize(int width, int height, int measureSpecWidth, int measureSpecHeight,
                int leftTopPadding, int bottomRightPadding) {
        ...
        public void validateCalculatedSize(int expectedWidth, int expectedHeight,
                int expectedMaxRows, int expectedMaxCols, int margin, int leftTopPadding,
                int bottomRightPadding, int spacing, int measureSpecWidth, int measureSpecHeight) {
            int measuredWidth = getMeasuredWidth();
            int measuredHeight = getMeasuredHeight();
            String message = "Layout is incorrectly sized. Note: Requested margin was: " + margin
                    + ", padding: (" + leftTopPadding + "," + bottomRightPadding
                    + "), and spacing in-between: " + spacing + ". Failure checking Layout.";
            if (measureSpecWidth == MeasureSpec.EXACTLY
                ...
                int expectedWidthWithBuffers = expectedWidth + leftTopPadding + bottomRightPadding
                        + (expectedMaxCols * 2 * margin)
                        + (expectedMaxCols > 0 ? (expectedMaxCols - 1) * spacing : 0);
                int expectedHeightWithBuffers = expectedHeight + leftTopPadding + bottomRightPadding
         ...
         *         calculations.
         */
        public void validateView(String viewId, int column, int row, int expectedLeft,
                int expectedTop, int expectedWidth, int expectedHeight, int margin,
                int leftTopPadding, int spacing) {
            ...
            int expectedLeftWithBuffers = expectedLeft + leftTopPadding
                    + ((1 + 2 * column) * margin) + (column * spacing);
            ...
            String message = "View '" + view.getTag() + "', expected to be in (zero-based) col "
                    ...
                    + ", padding: " + leftTopPadding + ", and spacing: " + spacing
        ...
        public void assertViewExpectations(ViewExpectation expectationA,
    ...
    public void testNoWrapping(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        ...
        layout.validateCalculatedSize(570, 110, ONE_ROW, THREE_COLS, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_A_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, SECOND_COL, FIRST_ROW, 180, 0, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_C_ID, THIRD_COL, FIRST_ROW, 370, 0, VIEW_C_WIDTH, VIEW_C_HEIGHT,
                margin, leftTopPadding, spacing);
    }

    public void testAllTruncated(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
        layout.addTestViews(margin);
        ...
        layout.validateCalculatedSize(100, 300, THREE_ROWS, TRUNCATED_COLS, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_A_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, FIRST_COL, SECOND_ROW, 0, 90, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_C_ID, FIRST_COL, THIRD_ROW, 0, 190, VIEW_C_WIDTH, VIEW_C_HEIGHT,
                margin, leftTopPadding, spacing);
    }

    public void testOnePerLineWithSpace(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
        layout.addTestViews(margin);
        ...
        layout.validateCalculatedSize(200, 300, THREE_ROWS, ONE_COL, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_A_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, FIRST_COL, SECOND_ROW, 0, 90, VIEW_B_WIDTH, VIEW_B_HEIGHT,
    ...
    public void testTwoOnFirstOneOnNext(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
        layout.addTestViews(margin);
        ...
        // second.
        layout.layoutAtSize(400 + 2 * TWO_COLS * margin, 400, specWidth, specHeight, leftTopPadding,
                bottomRightPadding);
        layout.validateCalculatedSize(370, 210, TWO_ROWS, TWO_COLS, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_A_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, SECOND_COL, FIRST_ROW, 180, 0, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_C_ID, FIRST_COL, SECOND_ROW, 0, 100, VIEW_C_WIDTH, VIEW_C_HEIGHT,
                margin, leftTopPadding, spacing);
    }
    ...
    public void testUnbounded(
        ...
        layout.layoutAtSize(200 + 2 * margin, 300, MeasureSpec.EXACTLY, specHeight, leftTopPadding,
                bottomRightPadding);
        layout.validateCalculatedSize(200, 300, THREE_ROWS, ONE_COL, margin, leftTopPadding,
                bottomRightPadding, spacing, MeasureSpec.EXACTLY, specHeight);
        layout.validateView(VIEW_A_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, FIRST_COL, SECOND_ROW, 0, 90, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
    ...
    public void testTwoOnFirstOneOnNextReversed(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
        ...
        layout.layoutAtSize(400 + 2 * TWO_COLS * margin, 400, specWidth, specHeight, leftTopPadding,
                bottomRightPadding);
        layout.validateCalculatedSize(390, 200, TWO_ROWS, TWO_COLS, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_C_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_C_WIDTH, VIEW_C_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, SECOND_COL, FIRST_ROW, 200, 0, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_A_ID, FIRST_COL, SECOND_ROW, 0, 110, VIEW_A_WIDTH, VIEW_A_HEIGHT,
                margin, leftTopPadding, spacing);
    }

    public void testOneOnFirstTwoOnNextReversed(int specWidth, int specHeight, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
        layout.addTestViewsReverseOrder(margin);
        ...
        // second.
        layout.layoutAtSize(370 + (2 * TWO_COLS * margin) + spacing, 400, specWidth, specHeight,
                leftTopPadding, bottomRightPadding);
        // Remember: Views are: c, b, a = { 200, 110 }, { 190, 100 }, { 180, 90 }.
        layout.validateCalculatedSize(370, 210, TWO_ROWS, TWO_COLS, margin, leftTopPadding,
                bottomRightPadding, spacing, specWidth, specHeight);
        layout.validateView(VIEW_C_ID, FIRST_COL, FIRST_ROW, 0, 0, VIEW_C_WIDTH, VIEW_C_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_B_ID, FIRST_COL, SECOND_ROW, 0, 110, VIEW_B_WIDTH, VIEW_B_HEIGHT,
                margin, leftTopPadding, spacing);
        layout.validateView(VIEW_A_ID, SECOND_COL, SECOND_ROW, 190, 110, VIEW_A_WIDTH,
                VIEW_A_HEIGHT, margin, leftTopPadding, spacing);
    }
    ...
    public void testRtl(int specWidth, int width, int specHeight, int height, int leftTopPadding,
            int bottomRightPadding, int margin, int spacing, ViewExpectation expectationA,
            ViewExpectation expectationB, ViewExpectation expectationC) {
        WrappingLayoutSubclass layout = WrappingLayoutSubclass.create(
                mContext, leftTopPadding, bottomRightPadding, spacing);
    ...
    public void testWrappingLayoutRtl() {
        ...
        testRtl(MeasureSpec.EXACTLY, 1000, MeasureSpec.EXACTLY, 400, 10, 15, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 1000, MeasureSpec.EXACTLY, 400, 0, 0, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 1000, MeasureSpec.EXACTLY, 400, 15, 15, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 1000, MeasureSpec.EXACTLY, 400, 0, 0, 10, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 1000, MeasureSpec.EXACTLY, 400, 15, 15, 10, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 370 + 10 + 15, MeasureSpec.EXACTLY, 400, 10, 15, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 370, MeasureSpec.EXACTLY, 400, 0, 0, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 370 + 15 + 15, MeasureSpec.EXACTLY, 400, 15, 15, 0, 0,
        ...
        testRtl(MeasureSpec.EXACTLY, 370 + 4 * 10, MeasureSpec.EXACTLY, 400, 0, 0, 10, 0,
                new ViewExpectation(220, 10, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(10, 10, VIEW_B_WIDTH, VIEW_B_HEIGHT),
                new ViewExpectation(200, 130, VIEW_C_WIDTH, VIEW_C_HEIGHT));
        testRtl(MeasureSpec.EXACTLY, 370 + 4 * 10 + 15 + 15, MeasureSpec.EXACTLY, 400, 15, 15, 10,
                0, new ViewExpectation(235, 25, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(25, 25, VIEW_B_WIDTH, VIEW_B_HEIGHT),
                new ViewExpectation(215, 145, VIEW_C_WIDTH, VIEW_C_HEIGHT));
        testRtl(MeasureSpec.EXACTLY, 370 + 3, MeasureSpec.EXACTLY, 400, 0, 0, 0, 3,
                new ViewExpectation(193, 0, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(0, 0, VIEW_B_WIDTH, VIEW_B_HEIGHT),
                new ViewExpectation(173, 103, VIEW_C_WIDTH, VIEW_C_HEIGHT));
        testRtl(MeasureSpec.EXACTLY, 370 + 4 * 10 + 3, MeasureSpec.EXACTLY, 400, 0, 0, 10, 3,
                new ViewExpectation(223, 10, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(10, 10, VIEW_B_WIDTH, VIEW_B_HEIGHT),
                new ViewExpectation(203, 133, VIEW_C_WIDTH, VIEW_C_HEIGHT));
        testRtl(MeasureSpec.EXACTLY, 370 + 15 + 3 + 15, MeasureSpec.EXACTLY, 400, 15, 15, 0, 3,
                new ViewExpectation(208, 15, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(15, 15, VIEW_B_WIDTH, VIEW_B_HEIGHT),
                new ViewExpectation(188, 118, VIEW_C_WIDTH, VIEW_C_HEIGHT));
        testRtl(MeasureSpec.EXACTLY, 370 + 15 + 4 * 10 + 3 + 15, MeasureSpec.EXACTLY, 400, 15, 15,
                10, 3, new ViewExpectation(238, 25, VIEW_A_WIDTH, VIEW_A_HEIGHT),
                new ViewExpectation(25, 25, VIEW_B_WIDTH, VIEW_B_HEIGHT),

...
* Proto changes also require corresponding changes in [proto_visitors.h](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/sync/protocol/proto_visitors.h) and (where appropriate) in [proto_enum_conversions.h/cc](https://source.monyhar.org/monyhar/monyhar/src/+/main:components/sync/protocol/proto_enum_conversions.cc).

...
_PARTIAL_PACKAGE_NAMES = ['com/google', 'org/monyhar']

# The sources_json_file is generated by jacoco_instr.py with source directories
# and input path to non-instrumented jars.
# e.g.
# 'source_dirs': [
#   "chrome/android/java/src/org/monyhar/chrome/browser/toolbar/bottom",
#   "chrome/android/java/src/org/monyhar/chrome/browser/ui/system",
# ...]
# 'input_path':
#   '$CHROMIUM_OUTPUT_DIR/\

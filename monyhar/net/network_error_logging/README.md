...
[`NetworkErrorLoggingService`](https://source.monyhar.org/monyhar/monyhar/src/+/main:net/network_error_logging/network_error_logging_service.h;l=42;drc=a9e9d6cbb3e5920f9207118cf9501ff0745bb536),
...
[`HttpNetworkTransaction`](https://source.monyhar.org/monyhar/monyhar/src/+/main:net/http/http_network_transaction.cc;l=1364;drc=a9e9d6cbb3e5920f9207118cf9501ff0745bb536),
...
endpoint via the
[`ReportingService`](https://source.monyhar.org/monyhar/monyhar/src/+/main:net/reporting/reporting_service.h;l=56;drc=c3305c04ac6800d488bfc8b2f3249fd13186984a).

Received NEL policies are persisted to disk by a `PersistentNelStore`, whose
main implementation is the
[`SqlitePersistentReportingAndNelStore`](https://source.monyhar.org/monyhar/monyhar/src/+/main:net/extras/sqlite/sqlite_persistent_reporting_and_nel_store.h;l=30;drc=456596a0b27623349d38e49d0e9812b24d47d5d8).

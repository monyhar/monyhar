...
static const char* const server_allowlist_array[] = {
    "google.com", "linkedin.com", "book.com", ".monyhar.org", ".gag", "gog"};
...
static const UrlData urls[] = {
  ...
  { GURL("http://codereview.monyhar.org/634002/show"), HttpAuth::AUTH_SERVER,
    true, 1 << 3 },
  { GURL("http://code.google.com/p/monyhar/issues/detail?id=34505"),
    HttpAuth::AUTH_SERVER, true, 1 << 0 },
  { GURL("http://code.google.com/p/monyhar/issues/list?can=2&q=label:"
  ...
  { GURL("http://codereview.monyhar.org/646068/diff/4001/5003"),
    HttpAuth::AUTH_SERVER, true, 1 << 3 },
  { GURL("http://codereview.monyhar.gag/646068/diff/4001/5003"),
    HttpAuth::AUTH_SERVER, true, 1 << 4 },
  { GURL("http://codereview.monyhar.gog/646068/diff/4001/5003"),

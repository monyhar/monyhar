...
[`chromecast/media/cma/backend/proxy/`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/proxy/)
...
[`chromecast/`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/)
directory, is rather complex, so only the high-level will be discussed here.
When playing out media, an implementation of the
[`MediaPipelineBackend`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/public/media/media_pipeline_backend.h;l=36?q=mediapipelinebackend&ss=monyhar%2Fmonyhar%2Fsrc:chromecast%2F)
API will be created, and this will be wrapped by a platform-specific (e.g.
Android, Fuchsia, Desktop, etc…)
[`CmaBackend`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/api/cma_backend.h;l=24?q=cmabackend&sq=&ss=monyhar%2Fmonyhar%2Fsrc:chromecast%2F)
as
[exists today](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/)
...
-  Audio Data Proxying, or how the audio data is streamed across the
   [CastRuntimeAudioChannel](https://source.monyhar.org/monyhar/monyhar/src/+/main:third_party/openscreen/src/cast/cast_core/api/runtime/cast_audio_decoder_service.proto;l=231?q=castruntimeaudiochannel&sq=&ss=monyhar%2Fmonyhar%2Fsrc)
...
1. [`MultizoneAudioDecoderProxy`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/proxy/multizone_audio_decoder_proxy.h):
...
1. [`MultizoneAudioDecoderProxyImpl`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/proxy/multizone_audio_decoder_proxy_impl.h):
...
1. [`ProxyCallTranslator`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/proxy/proxy_call_translator.h):
   ...
   above layer.
1. [`CastRuntimeAudioChannelBroker`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/proxy/cast_runtime_audio_channel_broker.h):
...
#### enable_monyhar_runtime_cast_renderer

This flag enables or disables support for sending data across the
CastRuntimeAudioChannel. When enabled, the
[`CmaBackendFactoryImpl`](https://source.monyhar.org/monyhar/monyhar/src/+/main:chromecast/media/cma/backend/cma_backend_factory_impl.cc;l=32)
